...
class Draggable extends React.Component<DraggableProps, DraggableState> {
  ...
  constructor(props: DraggableProps) {
    ...
    this.ref = this.props.ref ?? React.createRef(null);
  ...
  componentDidMount() {
    ...
    if(typeof window.SVGElement !== 'undefined' && this.ref instanceof window.SVGElement) {
  ...
  render(): ReactElement<any> {
    ...
    return (
      <DraggableCore {...draggableCoreProps} ref={this.ref} onStart={this.onDragStart} onDrag={this.onDrag} onStop={this.onDragStop}>
